...
if __name__ == "__main__":
    for mapinfo in pull_rongzai_info():
        if mapinfo['minstance_ip'] == "192.168.118.118":
           conn =  CheckMysql(mapinfo['minstance_ip'])
           print mapinfo['project_name'] +":"+ mapinfo['minstance_ip'] + ":" +"read_only status is" + \
                 ":" +str(conn.check_readonly()[0][1])
        else:
            pass